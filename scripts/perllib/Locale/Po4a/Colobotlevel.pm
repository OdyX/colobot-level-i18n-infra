    ...
    while (defined($line)) {
        ...
        if ($line =~ /^(Title|Resume|ScriptName)/) {
            ...
            if( not $parE ) {
                ...
                $parE = $self->translate($E, 'charLangID', 'One-char language identifier');
            }
            ...
            my $quoted_1  = $3;
            my $spacing_2 = $4;
            my $par_1 = $self->translate($quoted_1, $ref, $type."-".$subtype_1);
            if( $5 ) {
                my $subtype_2 = $6;
                my $quoted_2  = $7;
            	my $spacing_3 = $8;
                my $par_2 = $self->translate($quoted_2, $ref, $type."-".$subtype_2);
